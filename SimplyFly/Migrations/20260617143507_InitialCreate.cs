        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInBaggage = table.Column<int>(type: "int", nullable: false),
                    CabinBaggage = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightCabins", x => x.CabinId);
                    table.ForeignKey(
                        name: "FK_FlightCabins_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "ScheduleId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookedSeats_FlightCabins_CabinId",
                        column: x => x.CabinId,
                        principalTable: "FlightCabins",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightCabins_ScheduleId",
                table: "FlightCabins",
                column: "ScheduleId");
